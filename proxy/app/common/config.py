...
class Config:
    ...
    # )
    KEYCLOAK_REALM_NAME: str = os.getenv("KEYCLOAK_REALM_NAME", "PGT")
    KEYCLOAK_CLIENT_ID: str = os.getenv("KEYCLOAK_CLIENT_ID", "PGT")
    KEYCLOAK_CLIENT_SECRET_KEY: str = os.getenv(
        "KEYCLOAK_CLIENT_SECRET_KEY", "km7whmkbJLCFMIk5OmfVtjlKasR4ZwL9"
    )
